...
@section('content')
<div class="p-6">
    <h1 class="text-2xl font-bold mb-4">Manager Reports</h1>
    ...
    <div class="mb-6 border p-4 rounded shadow-sm bg-white">
        ...
        <form action="{{ route('backend.manager.reports.generate') }}" method="POST" class="space-y-2">
            @csrf
            <div>
    ...
    <div class="mb-4 flex gap-2 items-end">
        <form method="GET" action="{{ route('backend.manager.reports.index') }}" class="flex gap-2 items-end">
            <div>
                <label>Type</label>
            ...
            <button type="submit" class="bg-gray-600 text-white px-3 py-1 rounded">Filter</button>
        </form>
    </div>
