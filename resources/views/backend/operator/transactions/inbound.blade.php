...
<div class="p-6 max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold">Inbound Transactions</h1>
        <a href="{{ route('backend.operator.inbound.create') }}"
    ...
    <div class="overflow-x-auto bg-white rounded shadow">
        <table class="w-full border-collapse">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="p-3 text-center text-gray-500">Tidak ada transaksi inbound</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
