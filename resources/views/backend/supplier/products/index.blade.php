...
<div class="p-6">
  ...
  <div class="flex justify-between items-center mb-4">
    ...
    <a href="{{ route('backend.supplier.products.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"> + Add Product</a>
   ...
   <tbody>
            ...
            <tr>
                ...
                <td class="px-4 py-2 border">
                    ...
                    <form action="{{ route('backend.supplier.products.destroy', $product) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
